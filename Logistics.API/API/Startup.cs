...
namespace API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // add repositoires 
            services.AddTransient<IAirExpRepository, AirExpRepository>();
            services.AddTransient<ICommodityRepository, CommodityRepository>();
            services.AddTransient<ITypeOfBillRepository, TypeOfBillRepository>();
            services.AddTransient<IShipmentRepository, ShipmentRepository>();
            services.AddTransient<INationalitiyRepository, NationalitiyRepository>();
            services.AddTransient<IUnitRepository, UnitRepository>();
            services.AddTransient<IPaymentRepository, PaymentRepository>();
            services.AddTransient<IExpressRepository, ExpressRepository>();
            services.AddTransient <IMBLTypeRepository, MBLTypeRespository>();
            services.AddTransient<IVesselRepository, VesselRepository>();
            services.AddTransient<IFreightRepository, FreightRepository>();
            services.AddTransient<IFclExpRepository, FclExpRepository>();
            services.AddTransient<ILclExpRepository, LclExpRepository>();
            services.AddTransient<IAirImpRepository, AirImpRepository>();
